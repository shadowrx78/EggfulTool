...
class RowIndex(tk.Canvas):
    ...
    # -----------------------------扩展-----------------------------
    def reset_width(self, width=None):
        if width == None:
            width = self.MT.default_row_index_width
    ...
    def get_default_width(self):
        return self.MT.default_row_index_width

    def set_default_width(self, width=None):
        if width == None:
            width = 70
        self.MT.default_row_index_width = width